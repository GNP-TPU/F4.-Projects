...
#define RESX_PORT	GPIOD
#define RESX_PIN	GPIO_PIN_10 //Reset pin
#define	DC_PORT		GPIOD
#define DC_PIN		GPIO_PIN_8 //DATA / Command select
...
void draw_char(unsigned int x, unsigned int y, char c, uint16_t colour, char size);
...
void draw_bitmap(unsigned int x, unsigned int y, const unsigned int *bmp);
