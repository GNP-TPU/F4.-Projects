...
#include <stdint.h>
//==============================================================================
#define ST77xx_CS_HIGH() 				GPIOA->ODR |= GPIO_ODR_OD8
#define ST77xx_CS_LOW() 				GPIOA->ODR &= ~GPIO_ODR_OD8

#define	ST77xx_DC_HIGH()				GPIOA->ODR |= GPIO_ODR_OD10
#define	ST77xx_DC_LOW()  				GPIOA->ODR &= ~GPIO_ODR_OD10

#define ST77xx_RST_HIGH() 			GPIOA->ODR |= GPIO_ODR_OD9
#define ST77xx_RST_LOW() 				GPIOA->ODR &= ~GPIO_ODR_OD9
//==============================================================================
#define ST77xx_Width   	320
#define ST77xx_Height 	170
#define ST77xx_X_Start  0
#define ST77xx_Y_Start  35
//==============================================================================
