...
// === Конечная точка 0 (Управление) ===
#define EP0_MAX_PACKET_SIZE     64

// === Конечная точка 1 (HID: Клавиатура + Медиа + Мышь) ===
#define EP1_IN_ADDR             0x81
#define EP1_MAX_PACKET_SIZE     16   // ИСПРАВЛЕНО: Степень двойки, хватает для репортов

// === Конечная точка 2 (CDC VCP: Управление / Command Interrupt) ===
#define EP2_IN_ADDR             0x82
#define EP2_MAX_PACKET_SIZE     8    // ИСПРАВЛЕНО: Стандарт для CDC прерываний

// === Конечная точка 3 (CDC VCP: Данные / Bulk Data) ===
#define EP3_IN_ADDR             0x83 // Направление IN (в компьютер)
#define EP3_OUT_ADDR            0x03 // Направление OUT (из компьютера)
#define EP3_MAX_PACKET_SIZE     64   // ДОБАВЛЕНО: Строго 64 для Full-Speed Bulk CDC
